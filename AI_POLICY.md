...
The Holoctty project has strict rules for AI usage:
...
These rules apply only to outside contributions to Holoctty. Maintainers
...
Please remember that Holoctty is maintained by humans.
...
Holoctty is written with plenty of AI assistance, and many maintainers embrace
