...
> **Holoctty:** this is a personal Ghostty fork. Ghostty's vouch, issue,
> and pull-request process below does **not** apply here. Do not open
> Holoctty changes against [ghostty-org/ghostty](https://github.com/ghostty-org/ghostty).
> See [README.md](README.md) and [UPSTREAM.md](UPSTREAM.md).
